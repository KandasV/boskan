              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <!-- Ana Ürün Resmi Başlangıç-->
                    <div>
                      <img src="images/urun8_1.jpg" width="390px" height="390" alt="..." />
                    </div>
                  <!-- Ana Ürün Resmi Bitiş -->

                    <div class="product_gallery">
                      <a>
                        <img src="images/urun8_2.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun8_3.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun8_4.jpg" alt="..." />
                      </a>
                    </div>
                  </div>
...
<!-- Parça Adı Başlangıç -->
  <h3 class="prod_title"> MSI GeForce RTX 4080 16GB GAMING X TRIO 16GB GDDR6X 256 Bit Ekran Kartı </h3>
<!-- Parça Adı Bitiş -->
<br /><br />
...
<!-- Temel Bilgiler Başlangıç -->
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
          ...
          Bellek Hızı : 22400 MHz
          </br>
          Çekirdek Hızı OC : TBD
          </br>
          Bellek Kapasitesi : 16GB GDDR6X
          </br>
          Bellek Arayüzü : 256-Bit-bit
        </div>
