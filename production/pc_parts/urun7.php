              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <!-- Ana Ürün Resmi Başlangıç-->
                    <div>
                      <img src="images/urun7_1.jpg" width="390px" height="390" alt="..." />
                    </div>
                  <!-- Ana Ürün Resmi Bitiş -->

                    <div class="product_gallery">
                      <a>
                        <img src="images/urun7_2.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun7_3.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun7_4.jpg" alt="..." />
                      </a>
                    </div>
                  </div>
...
<!-- Parça Adı Başlangıç -->
  <h3 class="prod_title"> MSI Radeon RX 6500 XT MECH 2X 4G OC 4GB GDDR6 64 Bit Ekran Kartı </h3>
<!-- Parça Adı Bitiş -->
<br /><br />
...
<!-- Temel Bilgiler Başlangıç -->
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
          ...
          GPU : Radeon RX 6500 XT MECH 2X 4G
          </br>
          Üretici : MSI
          </br>
          Bellek Hızı : 18000 MHz
          </br>
          Çekirdek Hızı OC : 2825 MHz
          </br>
          Bellek Kapasitesi : 4GB GDDR6
          </br>
          Bellek Arayüzü : 64-Bit-bit
        </div>
  ...
  <div class="x_content">
    <table class="table">
      ...
      <tbody>
        <tr>
          <td>GPU Model</td>
          <td>Radeon RX 6500 XT MECH 2X 4GL</td>
        </tr>
        <tr>
          <td>Bellek Tipi</td>
          <td>GDDR6</td>
