              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <!-- Ana Ürün Resmi Başlangıç-->
                    <div>
                      <img src="images/urun6_1.jpg" width="390px" height="390" alt="..." />
                    </div>
                  <!-- Ana Ürün Resmi Bitiş -->

                    <div class="product_gallery">
                      <a>
                        <img src="images/urun6_2.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun6_3.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun6_4.jpg" alt="..." />
                      </a>
                    </div>
                  </div>
...
<!-- Parça Adı Başlangıç -->
  <h3 class="prod_title"> NVIDIA GeForce RTX 3050 AERO ITX 8G OC 8GB GDDR6 128 Bit </h3>
<!-- Parça Adı Bitiş -->
<br /><br />
...
<!-- Temel Bilgiler Başlangıç -->
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
          ...
          GPU : MSI GeForce RTX 3050 AERO ITX 8G OC 8GB GDDR6 128 Bit LHR Ekran Kartı
</br>
          Üretici : MSI
          </br>
          Bellek Hızı : 14000 MHz
          </br>
          Çekirdek Hızı OC : 1807 MHz MHz
          </br>
          Bellek Kapasitesi : 8GB GDDR6
          </br>
