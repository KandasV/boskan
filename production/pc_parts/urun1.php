              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <!-- Ana Ürün Resmi Başlangıç-->
                    <div>
                      <img src="images/urun1_1.jpg" width="390px" height="390" alt="..." />
                    </div>
                  <!-- Ana Ürün Resmi Bitiş -->

                    <div class="product_gallery">
                      <a>
                        <img src="images/urun1_2.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun1_3.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun1_4.jpg" alt="..." />
                      </a>
                    </div>
                  </div>
...
<!-- Parça Adı Başlangıç -->
  <h3 class="prod_title"> MSI GeForce RTX 2060 VENTUS GP OC 6GB GDDR6 192 Bit Ekran Kartı </h3>
<!-- Parça Adı Bitiş -->
<br /><br />
...
<!-- Temel Bilgiler Başlangıç -->
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
          ...
          Üretici : NVIDIA
          Bellek Hızı : 14000Mhz
          Çekirdek Hızı OC : 1710Mhz
          Bellek Kapasitesi : 6GB GDDR6
